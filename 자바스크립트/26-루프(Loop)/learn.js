...
if (count >= 3 && count <= 4) {
  continue // 현재 고트에서 아래 코드 건너뛰고 다시 while 조건 확인 이동
}
...
// {}안이나, 변수를 밖으로 옮길수 있긴한데, 그러면 변수안에 ; 남아 있어야함
for (; k < l;) {
  console.log(k)
  ++k
}
...
// while문
{
  ...
  while (i >= 0) {
    const webFrameworksName = webFrameworks[i]
    console.log(webFrameworksName)
    i--
  }
}
