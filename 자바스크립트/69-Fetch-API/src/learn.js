...
const ENDPOINT = 'https://api.github.com/users/myj9713-dev'
...
//  변수 선언 없이 fetch에 바로 링크 작성
;(() => {
  
  // 서버와 비동기 통신해서 응답받은 결과를 화면에 출력하고 싶다.
  // 데이터를 제공하는 서버 URL: https://api.github.com/users/myj9713-dev
  fetch('https://api.github.com/users/myj9713-dev')
