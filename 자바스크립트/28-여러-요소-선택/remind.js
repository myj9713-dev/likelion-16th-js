...
console.log(queryAll) // NodeList(3) [li.character, li.character, li.character]

// 동적 수집(Live Collection)
// - getElementsByClassName
// - getElementsByTagName
const getElements = starWars.getElementsByClassName('character')
console.log(getElements) // HTMLCollection(3) [li.character, li.character, li.character]
...
manipulateButton.addEventListener('click', () => {
  ...
  // starWars의 자식 요소 노드로 새 항목(<li>) 추가
  starWars.innerHTML += '<li class="character" data-type="villain">카일로렌</li>'
