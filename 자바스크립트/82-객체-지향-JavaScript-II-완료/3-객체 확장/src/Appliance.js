...
const aircorn = new SmartAppliance('무풍 에어컨', 'StudyRoom_5G')
// console.log(aircorn)
// console.log(aircorn.turnOn())

// - 82인치 대형 TV (WiFi: 'LivingRoom_2.4G')
const wideTV = new SmartAppliance('82인치 대형 TV', 'LivingRoom_2.4G')
// console.log(wideTV)
// console.log(wideTV.turnOn())


// TODO 3-2: 무풍 에어컨을 '공부방'에 설치하고 전원을 켭니다.
introduceAppliance.call(aircorn, '공부방')
aircorn.turnOn()
...
setTimeout(() => {
  powerStandbyMode() // 전원 대기 상태에서 복구
  wideTV.turnOn() // TV의 전원을 켠다.
}, 2000)