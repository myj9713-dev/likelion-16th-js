...
orderedList.className += ' update-ol' // classList 밑에 += 추가하면 덮어쓸수있음. 띄어쓰기 없이. 클래스 이름은 띄어쓰기로 구분해서 위로 올리기
orderedList.classList.add('list', 'dictionary')
console.log(orderedList.className) // OLD, LEGACY
console.log(orderedList.classList.value) // NEW, MODERN
...
// 부모요소.insertBefore(삽입요소, 삽입할위치요소)
// 'K팝 노래0' 리스트 아이템 요소 삽입


// 삽입할 요소
const newListItem = document.createElement('li')
newListItem.textContent = 'K 팝 노래 0'
