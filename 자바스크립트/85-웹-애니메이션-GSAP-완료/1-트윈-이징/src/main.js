...
function handleSet() {
  ...
  // 참고: https://gsap.com/docs/v3/GSAP/Timeline/set()/
  //      https://gsap.com/docs/v3/GSAP/CorePlugins/CSS/#quick-reference
  // - 제어 대상: card
...
function handleFrom() {
  ...
  // 참고: https://gsap.com/docs/v3/GSAP/Timeline/from()/
  // - 제어 대상: card
  // - 제이 속성: duration, ease
...
function handleTo() {
  ...
  // 참고: https://gsap.com/docs/v3/GSAP/gsap.to()/
  // - 제어 대상: card
  gsap.to(card, {
    x: 50,
    rotation: 360,
...
function handleFromTo() {
  ...
  // 참고: https://gsap.com/docs/v3/GSAP/Timeline/gsap.fromTo()/
  // - 제어 대상: card
  // - from: vars 객체 설정
  // - to: vars 객체 설정
  gsap.fromTo(
    card,
    { x: -100, scale: 0, opacity: 0, rotation: 360 },
    { x: 0, scale: 1, opacity: 1, duration: 1, rotation: 0, ease: 'elastic.out(1, 0.5)' },
  )
}
