...
function UserCard(userName) {
  // 부모 생성자(BaseCard)를 빌려써서 자신의 속성을 정의
  BaseCard.call(this, 'User Profile', userName)
}

// UserCard.prototype <- [새로운 프로토타입 객체 생성] <- Object.create(BaseCard.prototype)
...
UserCard.prototype.render = function() {
  ...
  return originalHtml.replace('data-dashboard-card', 'datea-dashboard-card data-type="User"')
}
