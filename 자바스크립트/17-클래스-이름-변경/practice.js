...
const itemsContains = practice.querySelector('.item-contains')
// console.log(itemsContains)
const hasTextIndigo600Color = itemsContains.classList.contains("text-indigo-600")
...
// console.log(itemContainsTarget)
